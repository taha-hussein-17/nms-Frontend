...
export const MainLayout = memo(({ children }: MainLayoutProps) => {
  ...
  return (
    <div
      className={cn(
        "min-h-screen bg-background transition-colors duration-300 flex flex-col font-sans  mx-auto overflow-x-hidden",
    ...
    >
                ...
                >
                  ...
                  >
                    <img
                      src={Logo}
                      alt="Logo"
                      className=" h-5.5 md:w-6 h-6 object-contain brightness-0 invert"
                      style={{ width: "100%" }}
                    />
                  </div>
                </Link>
      ...
      {!isAuthenticated && <MemoizedFooter />}
    </div>
  );
});
